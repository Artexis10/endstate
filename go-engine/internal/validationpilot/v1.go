...
type V1Attempt struct {
	...
	InfrastructureCoordinate   string                  `json:"infrastructureCoordinate,omitempty"`
	DiagnosticEngineSHA256     string                  `json:"diagnosticEngineSha256,omitempty"`
