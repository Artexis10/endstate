...
func TestDecodeCandidateSet(t *testing.T) {
	tests := []struct {
		...
		{name: "NUL rationale", input: strings.Replace(candidateSetJSON(), `"rationale":"plausible product regression"`, `"rationale":"bad\u0000text"`, 1), wantErr: ErrInvalidManifest},
		...
		{name: "ESC violated behavior", input: strings.Replace(candidateSetJSON(), `"violatedBehavior":"declared product behavior"`, `"violatedBehavior":"bad\u001btext"`, 1), wantErr: ErrInvalidManifest},
...
func TestDecodeFrozenManifest(t *testing.T) {
	tests := []struct {
		...
		{name: "NUL violated behavior", input: strings.Replace(frozenManifestJSON(), `"violatedBehavior":"declared product behavior"`, `"violatedBehavior":"bad\u0000text"`, 1), wantErr: ErrInvalidManifest},
		{name: "ESC violated behavior", input: strings.Replace(frozenManifestJSON(), `"violatedBehavior":"declared product behavior"`, `"violatedBehavior":"bad\u001btext"`, 1), wantErr: ErrInvalidManifest},
