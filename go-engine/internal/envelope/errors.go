...
const (
	...
	ErrTestModeInvalid            ErrorCode = "TESTMODE_INVALID"
	ErrTestModeIsolationViolation ErrorCode = "TESTMODE_ISOLATION_VIOLATION"
	ErrTestModeCommandForbidden   ErrorCode = "TESTMODE_COMMAND_FORBIDDEN"
