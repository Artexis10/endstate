...
- [ ] 10.9 Re-run targeted and full Go tests, vet, build, OpenSpec validation, Windows/Linux verification, macOS CI, and an independent final review against the combined tree.
