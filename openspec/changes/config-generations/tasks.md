...
- [ ] 10.6 Merge `origin/main` at `9dc00c8cc29f9768a9cac880267624a09f90e7cb` into the config-generation branch in a disposable integration workspace, resolve and record inspection of the 16 known conflicts, and manually inspect the 10 shared files that Git auto-merges.
