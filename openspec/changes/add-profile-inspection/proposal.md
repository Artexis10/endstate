...
- Define deterministic profile-owned app and settings inventories, including tiered verified-owner association, duplicate-safe opaque row identities, canonical ownership normalization, composition/exclude handling, grouping, labels, warnings, counts, and the schema-1.x JSON result envelope.
