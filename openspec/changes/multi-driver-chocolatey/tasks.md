...
- [x] 7.6 Test documented Chocolatey Windows exit classifications without relying on Unix-truncated subprocess exit codes, then rerun the cross-platform Go CI gate
