# config-generation-resolution Specification

## Purpose
Defines engine-owned compatibility resolution, target-instance selection, collision handling, and safe non-execution for captured configuration sets.
