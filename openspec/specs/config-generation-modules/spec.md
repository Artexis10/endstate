# config-generation-modules Specification

## Purpose
Defines schema-v2 configuration sets and generations, stable identity and fingerprints, instance detection, version evidence, and schema-v1 compatibility.
