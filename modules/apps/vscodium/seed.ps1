<#
.SYNOPSIS
    Seeds meaningful VSCodium user configuration for curation testing.

.DESCRIPTION
    Sets up VSCodium configuration values that represent real-world user preferences
...
Write-Host " VSCodium Configuration Seeding (Curation Mode)" -ForegroundColor Cyan
Write-Host "=" * 60 -ForegroundColor Cyan
Write-Host ""
...
# PATHS
# ============================================================================
$vscodiumUserDir = Join-Path $env:APPDATA "VSCodium\User"
$settingsPath = Join-Path $vscodiumUserDir "settings.json"
$keybindingsPath = Join-Path $vscodiumUserDir "keybindings.json"

# Ensure directory exists
if (-not (Test-Path $vscodiumUserDir)) {
    Write-Step "Creating VSCodium user directory..."
    New-Item -ItemType Directory -Path $vscodiumUserDir -Force | Out-Null
}
...
$settings = @{
    ...
    # Git settings (for SCM integration)
...
Write-Host ""
Write-Host "=" * 60 -ForegroundColor Cyan
Write-Host " VSCodium Configuration Seeding Complete" -ForegroundColor Cyan
Write-Host "=" * 60 -ForegroundColor Cyan
Write-Host ""
